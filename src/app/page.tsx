  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden">
        ...
        <div className="relative flex-1 flex items-center justify-center px-4">
          <div className="w-full max-w-2xl text-center">
            ...
            <div className="relative inline-block mb-4">
              <h1 className="font-heading text-6xl sm:text-7xl md:text-8xl tracking-tight animate-fade-in">
            ...
            <p
              className="text-muted-foreground text-lg mb-10 animate-fade-in"
            ...
            <Link
              href="/home"
              className="group inline-flex items-center gap-2 mt-6 px-6 py-3 text-sm text-muted-foreground hover:text-foreground transition-colors animate-fade-in"
        ...
        {/* Trending Preview */}
        <div
          className="relative px-4 pb-12 animate-fade-in"
